...
final class ObjectBytes //nopub
{
    ...
    static byte[] toBytes(Object o) {
        ...
        try {
            ...
            gbt = getByteFromIs(new ByteArrayInputStream(objgbt), true);//if object big?true:false 2017.10
        } catch (Exception e) {
    ...
    static Object toObject(byte[] bts) {
        ...
        setByteToOs(bts, sbos, true);//if gzip byte[]?true:false 2017.10
    ...
    static byte[] getCharSequence(byte[] bts) {
    ...
    public static void main(String[] args) {
        ...
        mp.put("request.buynowjhtml.client-ip", "1.1.1.1");
        mp.put("request.buynowjhtml.header.referer", "http://buy_now.jhtml");
        mp.put("request.buynowjhtml.content.skuId", "");
        mp.put("request.buynowjhtml.content._fma.b._0.pr", "1.00");
        mp.put("request.buynowhtml.client-ip", "1.1.1.1");
        mp.put("request.buynowhtml.header.referer", "http://buy_now.html");
